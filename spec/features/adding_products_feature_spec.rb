...
if ENV['BROWSER']
  describe 'Adding products', type: :feature do
    it 'let\'s you add a product' do
      ...
      expect(page).not_to have_content 'Product name must be higher than 4 characters, please try again'
      visit '/'
      click_link 'Products'
    ...
    it 'doesn\'t let you add a product with invalid details' do
      ...
      click_button 'Add product'
      expect(page).not_to have_content 'Your product has been added'
      expect(page).to have_content 'Product name must be higher than 4 characters, please try again'
      visit '/'
      click_link 'Products'
